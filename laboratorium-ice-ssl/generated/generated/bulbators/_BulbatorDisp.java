...
// <auto-generated>
//
// Generated from file `_BulbatorDisp.java'
//
...
public abstract class _BulbatorDisp extends Ice.ObjectImpl implements Bulbator
{
    protected void
    ...
    ___turnBulbulOff(Bulbator __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        __obj.turnBulbulOff(__current);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___turnBulbulOn(Bulbator __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        __obj.turnBulbulOn(__current);
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            ...
            case 13:
            {
                return ___turnBulbulOff(this, in, __current);
            }
            case 14:
            {
                return ___turnBulbulOn(this, in, __current);
            }
        }
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type generated::bulbators::Bulbator was not generated with stream support";
        throw ex;
    }
