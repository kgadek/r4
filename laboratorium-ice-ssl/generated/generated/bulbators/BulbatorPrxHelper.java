...
// <auto-generated>
//
// Generated from file `BulbatorPrxHelper.java'
//
...
public final class BulbatorPrxHelper extends Ice.ObjectPrxHelperBase implements BulbatorPrx
{
    public void
    turnBulbulOff()
    {
    ...
    turnBulbulOff(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _BulbatorDel __del = (_BulbatorDel)__delBase;
    ...
    public static BulbatorPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        BulbatorPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (BulbatorPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA(ice_staticId()))
                {
                    BulbatorPrxHelper __h = new BulbatorPrxHelper();
    ...
    __createDelegateM()
    {
        return new _BulbatorDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _BulbatorDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, BulbatorPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            BulbatorPrxHelper result = new BulbatorPrxHelper();
