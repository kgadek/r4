...
// <auto-generated>
//
// Generated from file `_BoomerangBulbulatorDisp.java'
//
...
public abstract class _BoomerangBulbulatorDisp extends Ice.ObjectImpl implements BoomerangBulbulator
{
    protected void
    ...
    ___throwAway(BoomerangBulbulator __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        __obj.throwAway(__current);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___getBack(BoomerangBulbulator __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        __obj.getBack(__current);
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            ...
            case 2:
            {
                return ___getBack(this, in, __current);
            }
            case 3:
            {
            ...
            case 14:
            {
                return ___throwAway(this, in, __current);
            }
            case 15:
            {
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type generated::bulbators::BoomerangBulbulator was not generated with stream support";
        throw ex;
    }
