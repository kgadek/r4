...
// <auto-generated>
//
// Generated from file `ColorBulbPrxHelper.java'
//
...
public final class ColorBulbPrxHelper extends Ice.ObjectPrxHelperBase implements ColorBulbPrx
{
    public void
    turnOff()
    {
    ...
    turnOff(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _ColorBulbDel __del = (_ColorBulbDel)__delBase;
                __del.turnOff(__ctx);
                return;
            }
    ...
    {
        changeColor(color, null, false);
    }

    public void
    changeColor(String color, java.util.Map<String, String> __ctx)
    {
        changeColor(color, __ctx, true);
    }

    private void
    changeColor(String color, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    private Ice.AsyncResult begin_changeColor(String color, java.util.Map<String, String> __ctx, boolean __explicitCtx, IceInternal.CallbackBase __cb)
    {
        IceInternal.OutgoingAsync __result = new IceInternal.OutgoingAsync(this, __changeColor_name, __cb);
        try
        {
            __result.__prepare(__changeColor_name, Ice.OperationMode.Normal, __ctx, __explicitCtx);
            IceInternal.BasicStream __os = __result.__os();
    ...
    {
        __end(__result, __changeColor_name);
    }
    ...
    public static ColorBulbPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        ColorBulbPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (ColorBulbPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA(ice_staticId()))
                {
                    ColorBulbPrxHelper __h = new ColorBulbPrxHelper();
    ...
    __createDelegateM()
    {
        return new _ColorBulbDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _ColorBulbDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, ColorBulbPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            ColorBulbPrxHelper result = new ColorBulbPrxHelper();
