...
// <auto-generated>
//
// Generated from file `BulbPrxHelper.java'
//
...
public final class BulbPrxHelper extends Ice.ObjectPrxHelperBase implements BulbPrx
{
    public void
    turnOff()
    {
    ...
    turnOff(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _BulbDel __del = (_BulbDel)__delBase;
                __del.turnOff(__ctx);
                return;
            }
    ...
    checkedCast(Ice.ObjectPrx __obj)
    {
        ...
        if(__obj != null)
        {
            ...
            catch(ClassCastException ex)
            {
                ...
                {
                    BulbPrxHelper __h = new BulbPrxHelper();
    ...
    __createDelegateM()
    {
        return new _BulbDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _BulbDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, BulbPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            BulbPrxHelper result = new BulbPrxHelper();
