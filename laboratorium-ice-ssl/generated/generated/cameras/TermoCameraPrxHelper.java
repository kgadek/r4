...
// <auto-generated>
//
// Generated from file `TermoCameraPrxHelper.java'
//
...
public final class TermoCameraPrxHelper extends Ice.ObjectPrxHelperBase implements TermoCameraPrx
{
    public void
    turn(double angle)
    {
    ...
    turn(double angle, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _TermoCameraDel __del = (_TermoCameraDel)__delBase;
    ...
    public static TermoCameraPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        TermoCameraPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (TermoCameraPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA(ice_staticId()))
                {
                    TermoCameraPrxHelper __h = new TermoCameraPrxHelper();
    ...
    __createDelegateM()
    {
        return new _TermoCameraDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _TermoCameraDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, TermoCameraPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            TermoCameraPrxHelper result = new TermoCameraPrxHelper();
