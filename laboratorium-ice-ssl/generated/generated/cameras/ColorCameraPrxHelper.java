...
// <auto-generated>
//
// Generated from file `ColorCameraPrxHelper.java'
//
...
public final class ColorCameraPrxHelper extends Ice.ObjectPrxHelperBase implements ColorCameraPrx
{
    public void
    turn(double angle)
    {
    ...
    turn(double angle, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _ColorCameraDel __del = (_ColorCameraDel)__delBase;
    ...
    private String
    getColor(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    private Ice.AsyncResult begin_getColor(java.util.Map<String, String> __ctx, boolean __explicitCtx, IceInternal.CallbackBase __cb)
    {
        ...
        try
        {
            __result.__prepare(__getColor_name, Ice.OperationMode.Normal, __ctx, __explicitCtx);
            IceInternal.BasicStream __os = __result.__os();
            __os.endWriteEncaps();
            __result.__send(true);
        }
    ...
    public static ColorCameraPrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        ColorCameraPrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (ColorCameraPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA(ice_staticId()))
                {
                    ColorCameraPrxHelper __h = new ColorCameraPrxHelper();
    ...
    __createDelegateM()
    {
        return new _ColorCameraDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _ColorCameraDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, ColorCameraPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            ColorCameraPrxHelper result = new ColorCameraPrxHelper();
