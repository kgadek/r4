...
// <auto-generated>
//
// Generated from file `_TelescopeDisp.java'
//
...
public abstract class _TelescopeDisp extends Ice.ObjectImpl implements Telescope
{
    protected void
    ...
    ___turn(Telescope __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        ...
        __is.endReadEncaps();
        __obj.turn(angle, __current);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___zoom(Telescope __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        short zoomLevel;
        zoomLevel = __is.readShort();
        __is.endReadEncaps();
        __obj.zoom(zoomLevel, __current);
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type generated::telescopes::Telescope was not generated with stream support";
        throw ex;
    }
