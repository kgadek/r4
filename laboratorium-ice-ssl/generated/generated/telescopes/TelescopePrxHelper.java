...
// <auto-generated>
//
// Generated from file `TelescopePrxHelper.java'
//
...
public final class TelescopePrxHelper extends Ice.ObjectPrxHelperBase implements TelescopePrx
{
    public void
    actionPerformed()
    {
    ...
    actionPerformed(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _TelescopeDel __del = (_TelescopeDel)__delBase;
    ...
    public static TelescopePrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        TelescopePrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (TelescopePrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA(ice_staticId()))
                {
                    TelescopePrxHelper __h = new TelescopePrxHelper();
    ...
    __createDelegateM()
    {
        return new _TelescopeDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _TelescopeDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, TelescopePrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            TelescopePrxHelper result = new TelescopePrxHelper();
