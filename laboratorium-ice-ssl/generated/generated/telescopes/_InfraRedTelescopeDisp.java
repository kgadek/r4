...
// <auto-generated>
//
// Generated from file `_InfraRedTelescopeDisp.java'
//
...
public abstract class _InfraRedTelescopeDisp extends Ice.ObjectImpl implements InfraRedTelescope
{
    protected void
    ...
    ___getTemp(InfraRedTelescope __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        String __ret = __obj.getTemp(__current);
        __os.writeString(__ret);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___focusOnHighestTemp(InfraRedTelescope __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.is().skipEmptyEncaps();
        __obj.focusOnHighestTemp(__current);
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            ...
            case 2:
            {
                return ___focusOnHighestTemp(this, in, __current);
            }
            case 3:
            {
            ...
            case 15:
            {
                return _TelescopeDisp.___turn(this, in, __current);
            }
            case 16:
            {
                return _TelescopeDisp.___zoom(this, in, __current);
            }
        }
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type generated::telescopes::InfraRedTelescope was not generated with stream support";
        throw ex;
    }
