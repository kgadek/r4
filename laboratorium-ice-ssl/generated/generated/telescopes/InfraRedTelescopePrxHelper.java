...
// <auto-generated>
//
// Generated from file `InfraRedTelescopePrxHelper.java'
//
...
public final class InfraRedTelescopePrxHelper extends Ice.ObjectPrxHelperBase implements InfraRedTelescopePrx
{
    public void
    actionPerformed()
    {
    ...
    actionPerformed(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _InfraRedTelescopeDel __del = (_InfraRedTelescopeDel)__delBase;
    ...
    focusOnHighestTemp()
    {
        focusOnHighestTemp(null, false);
    }

    public void
    focusOnHighestTemp(java.util.Map<String, String> __ctx)
    {
        focusOnHighestTemp(__ctx, true);
    }

    private void
    focusOnHighestTemp(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __delBase = __getDelegate(false);
                _InfraRedTelescopeDel __del = (_InfraRedTelescopeDel)__delBase;
                __del.focusOnHighestTemp(__ctx);
                return;
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
    ...
    private static final String __focusOnHighestTemp_name = "focusOnHighestTemp";

    public Ice.AsyncResult begin_focusOnHighestTemp()
    {
        return begin_focusOnHighestTemp(null, false, null);
    }

    public Ice.AsyncResult begin_focusOnHighestTemp(java.util.Map<String, String> __ctx)
    {
        return begin_focusOnHighestTemp(__ctx, true, null);
    }

    public Ice.AsyncResult begin_focusOnHighestTemp(Ice.Callback __cb)
    {
        return begin_focusOnHighestTemp(null, false, __cb);
    }

    public Ice.AsyncResult begin_focusOnHighestTemp(java.util.Map<String, String> __ctx, Ice.Callback __cb)
    {
        return begin_focusOnHighestTemp(__ctx, true, __cb);
    }

    public Ice.AsyncResult begin_focusOnHighestTemp(Callback_InfraRedTelescope_focusOnHighestTemp __cb)
    {
        return begin_focusOnHighestTemp(null, false, __cb);
    }

    public Ice.AsyncResult begin_focusOnHighestTemp(java.util.Map<String, String> __ctx, Callback_InfraRedTelescope_focusOnHighestTemp __cb)
    {
        return begin_focusOnHighestTemp(__ctx, true, __cb);
    }

    private Ice.AsyncResult begin_focusOnHighestTemp(java.util.Map<String, String> __ctx, boolean __explicitCtx, IceInternal.CallbackBase __cb)
    {
        IceInternal.OutgoingAsync __result = new IceInternal.OutgoingAsync(this, __focusOnHighestTemp_name, __cb);
        try
        {
            __result.__prepare(__focusOnHighestTemp_name, Ice.OperationMode.Normal, __ctx, __explicitCtx);
            IceInternal.BasicStream __os = __result.__os();
            __os.endWriteEncaps();
            __result.__send(true);
        }
    ...
    {
        __end(__result, __focusOnHighestTemp_name);
    }

    public String
    getTemp()
    {
        return getTemp(null, false);
    }

    public String
    getTemp(java.util.Map<String, String> __ctx)
    {
        return getTemp(__ctx, true);
    }

    private String
    getTemp(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("getTemp");
                __delBase = __getDelegate(false);
                _InfraRedTelescopeDel __del = (_InfraRedTelescopeDel)__delBase;
                return __del.getTemp(__ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex);
    ...
    {
        return begin_getTemp(null, false, null);
    }

    public Ice.AsyncResult begin_getTemp(java.util.Map<String, String> __ctx)
    {
        return begin_getTemp(__ctx, true, null);
    }

    public Ice.AsyncResult begin_getTemp(Ice.Callback __cb)
    {
        return begin_getTemp(null, false, __cb);
    }

    public Ice.AsyncResult begin_getTemp(java.util.Map<String, String> __ctx, Ice.Callback __cb)
    {
        return begin_getTemp(__ctx, true, __cb);
    }

    public Ice.AsyncResult begin_getTemp(Callback_InfraRedTelescope_getTemp __cb)
    {
        return begin_getTemp(null, false, __cb);
    }

    public Ice.AsyncResult begin_getTemp(java.util.Map<String, String> __ctx, Callback_InfraRedTelescope_getTemp __cb)
    {
        return begin_getTemp(__ctx, true, __cb);
    }

    private Ice.AsyncResult begin_getTemp(java.util.Map<String, String> __ctx, boolean __explicitCtx, IceInternal.CallbackBase __cb)
    {
        __checkAsyncTwowayOnly(__getTemp_name);
        IceInternal.OutgoingAsync __result = new IceInternal.OutgoingAsync(this, __getTemp_name, __cb);
        try
        {
            __result.__prepare(__getTemp_name, Ice.OperationMode.Normal, __ctx, __explicitCtx);
            IceInternal.BasicStream __os = __result.__os();
            __os.endWriteEncaps();
            __result.__send(true);
        }
    ...
    {
        Ice.AsyncResult.__check(__result, this, __getTemp_name);
        if(!__result.__wait())
        {
            try
            {
    ...
    public static InfraRedTelescopePrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        InfraRedTelescopePrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (InfraRedTelescopePrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA(ice_staticId()))
                {
                    InfraRedTelescopePrxHelper __h = new InfraRedTelescopePrxHelper();
    ...
    public static final String[] __ids =
    {
        ...
        "::generated::telescopes::InfraRedTelescope",
        "::generated::telescopes::Telescope"
    };
    ...
    __createDelegateM()
    {
        return new _InfraRedTelescopeDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _InfraRedTelescopeDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, InfraRedTelescopePrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            InfraRedTelescopePrxHelper result = new InfraRedTelescopePrxHelper();
